...
<div id="settings" class="blocks">
    ...
    <div class="text-block">
        ...
        <div style="float: left;padding: 20px;">
        	<input type="button" value="Refresh" class="btn btn-blue" id="refresh_log_button" />
        	...
        	<input type="button" value="Clear log" class="btn btn-red" id="clear_log_button" />
        ...
        <div style="float: right;padding: 20px;">
        	<a href="<?php echo $this->config->item('base_url'); ?>dev/seedevlog" target="_blank">see dev log</a>
        </div>
         -->
    </div>
