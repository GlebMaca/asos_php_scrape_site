...
function checkProxy(){
    ...
    if((int) ($now - $last_time) > 20){
        // update PROXY LIST
        //$result = file_get_contents('https://multiscraper.com/api/getProxy/mspro');
        $result = file_get_contents('https://multiscraper.com/public/files/proxy.txt');
...
function getUserAgents_taobao(){
    ...
    $user_agent[] = 'Opera/9.80 (Windows NT 5.1; U; en) Presto/2.9.168 Version/11.51';
    $user_agent[] = 'Mozilla/5.0 (Windows; I; Windows NT 5.1; en; rv:1.9.2.13) Gecko/20100101 Firefox/4.0';
    $user_agent[] = 'Opera/9.80 (Windows NT 6.1; U; en) Presto/2.8.131 Version/11.10';
    $user_agent[] = 'Opera/9.80 (Macintosh; Intel Mac OS X 10.6.7; U; en) Presto/2.8.131 Version/11.10';
    $user_agent[] = 'Mozilla/5.0 (Macintosh; I; Intel Mac OS X 10_6_7; en-US) AppleWebKit/534.31+ (KHTML, like Gecko) Version/5.0.5 Safari/533.21.1';
