...
function mspro_aliexpress_description($html){
		...
		// clear
		$out = str_replace(array("<p>	&nbsp; </p>" , '<p> &nbsp; </p>' , '<div style="font-size: 0.0px;margin: 0 auto;color: </div>' , '<div style="font-size: 0.0px;margin: 0 auto;color:</div>') ,'' , $out);
		$out = str_replace(array("<p>	&nbsp; </p>" , '<p> &nbsp; </p>') ,'' , $out);
		$out = str_replace(array('<div class="detailmodule_dynamic"><kse:widget data-widget-type="relatedProduct" id="34552083" title="" type="relation"></kse:widget></div>' ,		    
		 '<a></a>',
		 ' class="detailmodule_html"' ,
		 ' class="detail-desc-decorate-richtext"'
		) ,'' , $out);
		// remove scripts
		$out = str_ireplace(array("<noscript>" , "</noscript>") , array("" , "") , $out);
